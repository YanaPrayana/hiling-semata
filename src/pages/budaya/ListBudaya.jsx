  ...
  return (
    <div className="hiling-root">
      <style>{`
        ...
        .hiling-root { font-family:'Cormorant Garamond',Georgia,serif; background:#12100a; color:#fff; min-height:100vh; }
        ...
        .hero-bg::after { content:''; position:absolute; inset:0; background:linear-gradient(105deg,rgba(8,6,2,.96) 34%,rgba(8,6,2,.45) 70%,rgba(8,6,2,.15) 100%),linear-gradient(to top,rgba(8,6,2,.9) 0%,transparent 55%); }
        ...
        .hero-btn { display:inline-flex; align-items:center; gap:8px; padding:12px 24px; border:1px solid #b8963e; color:#c9a452; font-family:'Lato',sans-serif; font-size:13px; letter-spacing:.1em; background:transparent; cursor:pointer; transition:all .3s; text-decoration:none; }
        ...
        /* FILTER */
        .filter-bar { background:#f2e9d8; border-bottom:1px solid rgba(184,150,62,.2); position:sticky; top:64px; z-index:40; }
        .filter-inner { max-width:1200px; margin:0 auto; padding:0 24px; display:flex; overflow-x:auto; scrollbar-width:none; }
        .filter-inner::-webkit-scrollbar { display:none; }
        .filter-btn { display:flex; flex-direction:column; align-items:center; gap:4px; padding:14px 20px; border:none; background:transparent; cursor:pointer; border-bottom:2px solid transparent; transition:all .2s; white-space:nowrap; font-family:'Lato',sans-serif; font-size:11px; letter-spacing:.08em; color:#7a6a50; text-transform:uppercase; }
        ...
        .see-all { font-family:'Lato',sans-serif; font-size:13px; color:#8b6914; text-decoration:none; }
        ...
        /* CARD FEATURED */
        .card-featured { position:relative; border-radius:12px; overflow:hidden; min-height:440px; display:flex; flex-direction:column; justify-content:flex-end; cursor:pointer; transition:transform .3s; text-decoration:none; }
        ...
        .card-featured::after { content:''; position:absolute; inset:0; background:linear-gradient(to top,rgba(8,5,1,.97) 0%,rgba(8,5,1,.5) 50%,rgba(8,5,1,.1) 100%); }
        ...
        /* CARDS SMALL */
        .cards-small { display:flex; flex-direction:column; gap:16px; height:100%; }
        .card-small { position:relative; border-radius:10px; overflow:hidden; flex:1; min-height:120px; cursor:pointer; transition:transform .3s; text-decoration:none; display:block; }
        .card-small:hover { transform:translateY(-3px); }
        .card-small img { width:100%; height:100%; object-fit:cover; }
        .card-small::after { content:''; position:absolute; inset:0; background:linear-gradient(105deg,rgba(8,5,1,.88) 35%,rgba(8,5,1,.2) 100%); }
        ...
        .sidebar-item { display:flex; align-items:center; justify-content:space-between; padding:11px 18px; border-bottom:1px solid #f0e8d8; cursor:pointer; transition:background .2s; width:100%; border-left:none; border-right:none; border-top:none; background:transparent; text-align:left; }
        ...
        .trip-card-img::after { content:''; position:absolute; inset:0; background:linear-gradient(to top,rgba(8,5,1,.85) 0%,transparent 55%); }
        ...
        .trip-btn { display:block; width:100%; text-align:center; padding:9px; border:1px solid #b8963e; color:#8b6914; font-family:'Lato',sans-serif; font-size:12px; background:transparent; cursor:pointer; border-radius:4px; transition:all .3s; text-decoration:none; }
      ...
      <section className="cerita-wrap">
        <div className="cerita-inner">
          ...
          <div className="cerita-grid">
            {/* Featured */}
            {featured && (
              <Link to={`/budaya/${featured.id}`} className="card-featured">
                <img
                  src={featured.gambar}
                  alt={featured.nama}
                  onError={(e) => {
